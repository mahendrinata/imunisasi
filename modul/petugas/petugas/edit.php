...
<div class="onecolumn">
  ...
  <br class="clear"/>
  <div class="content">
    <form method="post" action="modul/petugas/petugas/aksi.php?act=edit" onSubmit="return validasi(this)" id="form_data">
    ...
    <table class="data" cellpadding="0" cellspacing="0" width="100%">
      ...
      <tr>
        <th>Tanggal Lahir</th>
        <td><input type="text" name="tgl_lahir" id="tgl_lahir"  value="<?php echo $r[tgl_lahir]; ?>" maxlength="10" size="10" onkeypress="return isNoneKey(event)"/></td>
      </tr>
      <tr>
        <th>Jenis Kelamin</th>
        <td>
