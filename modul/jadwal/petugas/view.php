          ...
          while($r=mysql_fetch_array($jadwal)){
            ...
            echo "$line
              ...
              <td>
                ...
                <a href='modul/jadwal/petugas/aksi.php?act=delete&id=$r[id]' title='Delete Data jadwal $r[nama]' onClick=\"return confirm('Apakah Anda ingin mengahapus $r[nama]?')\"><img src='template/images/icon_delete.png'></a>
              </td>
            </tr>";
            $no++;
          }
