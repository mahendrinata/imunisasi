<div class="onecolumn">
  ...
  <br class="clear"/>
  <div class="content">
    <form method="post" action="modul/ibu/petugas/aksi.php?act=change" id="form_data">
          ...
          while($r=mysql_fetch_array($ibu)){
            ...
            echo "$line
              ...
              <td>
                ...
                <a href='modul/ibu/petugas/aksi.php?act=delete&id=$r[id]' title='Delete Data Ibu $r[nama]' onClick=\"return confirm('Apakah Anda ingin mengahapus $r[nama]?')\"><img src='template/images/icon_delete.png'></a>
              </td>
            </tr>";
            $no++;
          }
