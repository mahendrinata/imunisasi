<div class="onecolumn">
  ...
  <br class="clear"/>
  <div class="content">
    <form method="post" action="modul/balita/petugas/aksi.php?act=change" id="form_data">
          ...
          while($r=mysql_fetch_array($balita)){
            ...
            echo "$line
              ...
              <td>
                ...
                <a href='modul/balita/petugas/aksi.php?act=delete&id=$r[id]' title='Delete Data balita $r[nama]' onClick=\"return confirm('Apakah Anda ingin mengahapus $r[nama]?')\"><img src='template/images/icon_delete.png'></a> ";
                if($r[jadwal] == 0){
                  echo "<a href='modul/balita/petugas/aksi.php?act=create&id=$r[id]&tgl=$r[tgl_lahir]' title='Buat Jadwal Imunisasi $r[nama]' onClick=\"return confirm('Apakah Anda ingin Membuat Jadwal Imunisasi $r[nama]?')\"><img src='template/images/edit.png'></a>";
                 }
              echo "</td>
            </tr>";
            $no++;
