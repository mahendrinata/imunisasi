      ...
      <tbody>
        ...
        <?php
          $balita=mysql_query("SELECT balita.*,
                            ...
                            WHERE balita.id_posyandu = '$_SESSION[id_posyandu]'");
          while($r=mysql_fetch_array($balita)){
            ...
            echo "$line
              ...
              <td>
                ...
                <a href='modul/balita/bidan/aksi.php?act=delete&id=$r[id]' title='Delete Data balita $r[nama]' onClick=\"return confirm('Apakah Anda ingin mengahapus $r[nama]?')\"><img src='template/images/icon_delete.png'></a>";
                if($r[jadwal] == 0){
