<div class="onecolumn">
  ...
  <br class="clear"/>
  <div class="content">
    <form method="post" action="modul/imunisasi_balita/petugas/aksi.php?act=change" id="form_data">
          ...
          while($r=mysql_fetch_array($imunisasi_balita)){
            ...
            echo "$line
              ...
              <td>
                ...
                <a href='modul/imunisasi_balita/petugas/aksi.php?act=delete&id=$r[id]' title='Delete Data imunisasi_balita $r[nama]' onClick=\"return confirm('Apakah Anda ingin mengahapus $r[nama]?')\"><img src='template/images/icon_delete.png'></a>
              </td>
            </tr>";
            $no++;
          }
