function PrintContent(ctrl)
    {
        ...
        var WindowObject = window.open('', "TrackHistoryData", 
                              "width=900,height=600,top=250,left=345,toolbars=no,scrollbars=no,status=no,resizable=no");
        //alert(ctrl);
        //alert(DocumentContainer);
...
var chartWidth = '700px';
var chartHeight = '350px';
...
$(function(){ 
	...
	$('#content .content a').tipsy({gravity: 'n'});

	$('#content .content img#foto').tipsy({gravity: 'n'});
